  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved variant as @variant" do
        ...
        post :create, {:variant => { "sku" => "invalid value" }}, valid_session
        assigns(:variant).should be_a_new(Variant)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested variant" do
        ...
        Variant.any_instance.should_receive(:update).with({ "sku" => "MyString" })
        put :update, {:id => variant.to_param, :variant => { "sku" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the variant as @variant" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Variant.any_instance.stub(:save).and_return(false)
        put :update, {:id => variant.to_param, :variant => { "sku" => "invalid value" }}, valid_session
        assigns(:variant).should eq(variant)
      end
