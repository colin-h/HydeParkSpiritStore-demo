...
describe ProductPropertiesController do
  ...
  describe "GET index" do
    it "assigns all product_properties as @product_properties" do
      ...
      assigns(:product_properties).should eq([product_property])
    end
  end
  ...
  describe "GET show" do
    it "assigns the requested product_property as @product_property" do
      ...
      assigns(:product_property).should eq(product_property)
    end
  end
  ...
  describe "GET new" do
    it "assigns a new product_property as @product_property" do
      ...
      assigns(:product_property).should be_a_new(ProductProperty)
    end
  end
  ...
  describe "POST create" do
    describe "with valid params" do
      ...
      it "assigns a newly created product_property as @product_property" do
        post :create, {:product_property => valid_attributes}, valid_session
        assigns(:product_property).should be_a(ProductProperty)
        assigns(:product_property).should be_persisted
      end

      it "redirects to the created product_property" do
        post :create, {:product_property => valid_attributes}, valid_session
        response.should redirect_to(ProductProperty.last)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved product_property as @product_property" do
        ...
        ProductProperty.any_instance.stub(:save).and_return(false)
        post :create, {:product_property => { "primary" => "invalid value" }}, valid_session
        assigns(:product_property).should be_a_new(ProductProperty)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested product_property" do
        product_property = ProductProperty.create! valid_attributes
        # Assuming there are no other product_properties in the database, this
        # specifies that the ProductProperty created on the previous line
        # receives the :update_attributes message with whatever params are
        # submitted in the request.
        ProductProperty.any_instance.should_receive(:update).with({ "primary" => "false" })
        put :update, {:id => product_property.to_param, :product_property => { "primary" => "false" }}, valid_session
      end
      ...
      it "redirects to the product_property" do
        product_property = ProductProperty.create! valid_attributes
        put :update, {:id => product_property.to_param, :product_property => valid_attributes}, valid_session
        response.should redirect_to(product_property)
      end
    end
    ...
    describe "with invalid params" do
      it "assigns the product_property as @product_property" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        ProductProperty.any_instance.stub(:save).and_return(false)
        put :update, {:id => product_property.to_param, :product_property => { "primary" => "invalid value" }}, valid_session
        assigns(:product_property).should eq(product_property)
      end
